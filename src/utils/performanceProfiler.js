...
export class PerformanceProfiler {
    ...
    async runFullAudit() {
        ...
        // Collect all metrics
        const [scrollMetrics, renderMetrics, memoryMetrics, domMetrics, reactMetrics, animationMetrics] = await Promise.all([
    ...
    exportProfile() {
        const profile = window.__performanceProfile;
        if (!profile) {
