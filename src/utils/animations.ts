...
export const AnimationHelpers = {
  ...
  staggerIn(elements: HTMLElement[] | string, stagger: number = 0.1) {
  ...
  addHoverScale(element: HTMLElement, scale: number = 1.05) {
  ...
  addParallax(element: HTMLElement | string, speed: number = 0.5) {
  ...
  typewriter(element: HTMLElement, text: string, speed: number = 80) {
    let currentIndex = 0;
    const type = () => {
